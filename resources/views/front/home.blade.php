...
<div class="widget">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="front/img/pop_right2.jpg" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="front/img/editor.jpg"
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="front/img/reader.jpg"
                                  alt="Generic placeholder image">
...
<div class="widget hidden-xs m30">
    <img class="img-responsive widget_img" src="front/img/podcast.jpg" alt="add_one">
</div>
<!--Advertisement-->
</div>
<!-- Right Section -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="logo footer-logo">
                    <a title="fontanero" href="index.html">
                        <img src="front/img/tech_about.jpg" alt="technews">
                    </a>
            ...
            <div class="col-md-3">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="front/img/editor_pic1.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="front/img/editor_pic2.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="front/img/editor_pic3.jpg"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
